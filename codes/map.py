...
class MapManager:
    ...
    def __init__(self, screen, player):
        ...
        ], battle=[Battle(False, place='combat')])  #permet de se téléporter d'une map à l'autre
        ...
        ], battle=[Battle(False, place='combat')])
    ...
    def check_collisions(self):         #Fonction vérifie collision et les portails
        ...
        for battle in self.get_map().battle:
            if battle:
                point = self.get_object(battle.place)
